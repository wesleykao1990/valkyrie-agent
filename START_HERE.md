...
5. Read `docs/IMPLEMENTATION_PLAN_M1_M2.md` for completed storage/package work,
   ...
   default-off Atomic fixture composition.
...
8. Start the mock developer console with `./bin/project-os-server`. For the
   ...
   separately configured `npm start` plus immutable local runner digest; do not
   add its feature flag to either default wrapper.
