CREATE TABLE inference_capabilities_v8 (
  id TEXT PRIMARY KEY,
...
INSERT INTO inference_capabilities_v8 SELECT * FROM inference_capabilities;

CREATE TABLE inference_requests_v8 (
  id TEXT PRIMARY KEY,
  capability_id TEXT NOT NULL REFERENCES inference_capabilities_v8(id),
  run_id TEXT NOT NULL REFERENCES runs(id),
  ...
  output_tokens INTEGER NOT NULL DEFAULT 0 CHECK (output_tokens BETWEEN 0 AND 131072),
  cost_micros INTEGER NOT NULL DEFAULT 0 CHECK (cost_micros BETWEEN 0 AND 100000000),
  reserved_at TEXT NOT NULL,
  completed_at TEXT,
  failure_code TEXT,
  UNIQUE(capability_id, role, request_hash)
);

INSERT INTO inference_requests_v8 SELECT * FROM inference_requests;

DROP TABLE inference_requests;
DROP TABLE inference_capabilities;
ALTER TABLE inference_capabilities_v8 RENAME TO inference_capabilities;
ALTER TABLE inference_requests_v8 RENAME TO inference_requests;
