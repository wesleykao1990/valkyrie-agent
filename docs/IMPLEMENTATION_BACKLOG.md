...
- [ ] Prime Agent benchmark and feature flag
- [ ] Orca deep links
- [ ] Optional Hermes portfolio dashboard plugin
- [ ] Automatic episodic capture after retrieval evaluation
- [ ] Linear AgentSession integration after preview stability
- [ ] Remote micro-VM sandbox option
